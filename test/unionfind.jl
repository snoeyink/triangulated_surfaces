...
@inline function union_sets!(sm::StarMatrix, vertex::Int, i::Int, j::Int)
    ...
    # Cycle detected. Notice the Int8(0) to maintain strict type stability!
    root_i == root_j && return false, (0, Int8(0), Int8(0))
...
"""
    undo!(sm::StarMatrix, record::Tuple{Int, Int8, Int8})
Restores the exact pointer modified by `union_sets!`.
"""
@inline function undo!(sm::StarMatrix, record::Tuple{Int, Int8, Int8})
